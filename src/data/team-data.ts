...
export const TeamListUnshuffled : TeamMember[] = [
  ...
  },
  {
    ...
    name: 'Josh Glover',
    bio: 'Josh is doing his meta-programming on the Meta team here at Klarna. Other than meta-circular interpreters, he loves football, reading, board games, teaching (functional) programming to kids and adults, and making dad jokes.'
  },
  {
